...
import './../../styles/bootstrap.min.css'; // Importamos estilos de Bootstrap
import './../../styles/Postulation.css'; // Importamos estilos personalizados
...
function ListPostulations() {
    ...
    useEffect(() => {
        // Obtener la lista de postulaciones
